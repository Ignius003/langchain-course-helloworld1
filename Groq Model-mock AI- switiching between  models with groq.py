...
def implement_llama_4_model():
    ...
    """
    llm1=ChatGroq(model="llama-4-8b-instant",temperature=0.0)
    return llm1
...
def implement_compare_models(prompt):
    ...
    response_llama4= implement_query_model(llama4,prompt)
    response_llama3_3= implement_query_model(llama3_3,prompt)
    
    return {
        "llama-4-8b-instant":response_llama4,
        "llama-3.3-70b-versatile":response_llama3_3
        }
    pass
